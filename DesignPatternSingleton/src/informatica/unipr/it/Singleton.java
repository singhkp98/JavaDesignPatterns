...
public class Singleton {
	...
	// put the array of strings (scrabbleLetters) inside the linked list 
	...
	public LinkedList<String> getLetterList(){
		//this is how you return a field inside of a singleton
	...
	public LinkedList<String> getTiles(int howManyTiles){
		...
		for(int i = 0; i <= howManyTiles; i++){
			...
			//send 'howManyTiles' to the user and remove them from the linked list 
			//so nobody can get them again
			tilesToSend.add(firstInstance.letterList.remove(0));
		
		}
		
		// Return the number of letter tiles requested to the function who called it
